          ...
          <div className="grid md:grid-cols-2 gap-4 my-8">
            <div className="bg-background border border-border rounded-xl p-5 flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Create a freely accessible, accurate Balti-English dictionary to document rare and traditional vocabulary.</p>
              </div>
            </div>
            
            <div className="bg-background border border-border rounded-xl p-5 flex gap-4">
              <div className="h-10 w-10 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3"/><path d="M21 8a2 2 0 0 0-2-2h-5a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2Z"/><path d="M21 14H11"/><path d="M15 8v8"/></svg>
              </div>
              <div>
                <h3 className="font-medium text-lg mb-1">Learn</h3>
                <p className="text-muted-foreground text-sm">Encourage language learning through intuitive, easy-to-use digital tools and resources.</p>
              </div>
            </div>
            ...
            <div className="bg-background border border-border rounded-xl p-5 flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Support both classical and modern Balti scripts to ensure complete documentation.</p>
              </div>
            </div>
            ...
            <div className="bg-background border border-border rounded-xl p-5 flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Open-source code available for community collaboration and continuous improvement.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 my-8">
            <div className="bg-background border-t-2 border-primary border-b border-x border-border rounded-xl p-5">
              <div className="h-12 w-12 mb-4 rounded-full bg-primary/10 text-primary flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20v-8"/><path d="M18 20V4"/><path d="M6 20v-4"/><path d="M12 12V4"/><path d="M6 16V4"/></svg>
              </div>
              <h3 className="font-medium text-lg mb-2">Add Words</h3>
              <p className="text-muted-foreground text-sm">Suggest new words or corrections to the dictionary from your knowledge of Balti.</p>
            </div>
            
            <div className="bg-background border-t-2 border-primary border-b border-x border-border rounded-xl p-5">
              <div className="h-12 w-12 mb-4 rounded-full bg-primary/10 text-primary flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/><path d="M14.5 9.5 16 8"/><path d="m14.5 14.5 1.5 1.5"/><path d="M9.5 14.5 8 16"/><path d="M9.5 9.5 8 8"/><path d="M21 12h1"/><path d="M2 12h1"/><path d="M12 21v1"/><path d="M12 2v1"/></svg>
              </div>
              <h3 className="font-medium text-lg mb-2">Develop</h3>
              <p className="text-muted-foreground text-sm">Help improve the app and website through our open-source code on GitHub.</p>
            </div>
            
            <div className="bg-background border-t-2 border-primary border-b border-x border-border rounded-xl p-5">
              <div className="h-12 w-12 mb-4 rounded-full bg-primary/10 text-primary flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 12a8 8 0 1 0-9.25 7.9"/><path d="M18 16v6"/><path d="M15 19h6"/></svg>
              </div>
              <h3 className="font-medium text-lg mb-2">Share</h3>
              <p className="text-muted-foreground text-sm">Spread the word about OpenBalti within your community and social networks.</p>
            </div>
          </div>

          <div className="bg-primary/5 border border-primary/10 rounded-2xl p-6 md:p-8 my-8">
            <h2 id="join-the-community" className="text-2xl font-bold mb-4">Join Our Community</h2>
            <p className="mb-6">Together, we can ensure that the Balti language thrives for generations to come. Connect with us and other contributors:</p>
