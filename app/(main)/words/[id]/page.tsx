          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h1 className={`text-4xl font-bold ${isBaltiToEnglish ? "font-tibetan" : ""}`}>{word.word}</h1>
                ...
                <div className="flex flex-col items-end gap-2">
                  ...
                  <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-xs">
                    {isBaltiToEnglish ? "Balti → English" : "English → Balti"}
                  </span>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h2 className="text-xl font-semibold mb-3">{isBaltiToEnglish ? "Meaning" : "Translation"}</h2>
                    <p className={`text-gray-700 ${!isBaltiToEnglish ? "font-tibetan" : ""}`}>{word.meaning}</p>
                    ...
                    {word.pronunciation && (
                      <div className="mb-4">
                        <h2 className="text-xl font-semibold mb-2">
                          {isBaltiToEnglish ? "Pronunciation" : "Additional Notes"}
                        </h2>
