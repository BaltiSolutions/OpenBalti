      ...
      <div className="max-w-4xl mx-auto mt-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Preserving and promoting the Balti language through open collaboration. Our bidirectional dictionary
            supports both Balti to English and English to Balti translations.
          </p>
        </div>
